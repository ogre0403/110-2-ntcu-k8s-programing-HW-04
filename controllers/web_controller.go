...
import (
	...
	hw4v1alpha1 "github.com/ogre0403/110-2-ntcu-k8s-programing/api/v1alpha1"
)
...
func (r *WebReconciler) newDeployment(s *hw4v1alpha1.Web) *appv1.Deployment {
	dm := &appv1.Deployment{
...
func (r *WebReconciler) newService(s *hw4v1alpha1.Web) *corev1.Service {
	sm := &corev1.Service{
		ObjectMeta: metav1.ObjectMeta{
			Name: s.Name,
			Labels: map[string]string{
